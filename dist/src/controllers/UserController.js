...
var UserController = /** @class */ (function () {
    ...
    UserController.createUser = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, password, userRepository, userCreated, user, res, error_1, res;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        user = _b.sent();
                        res = { message: "Usuario cadastrado", type: "success", body: user };
    ...
    UserController.logIn = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, emailUser, passwordUser, userRepository, user, res_1, res, error_2, res;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, emailUser = _a.emailUser, passwordUser = _a.passwordUser;
                        userRepository = (0, typeorm_1.getConnection)().getCustomRepository(UserRepository_1.UserRepository);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, userRepository.findOne({ where: { email: emailUser, password: passwordUser } })];
                    case 2:
                        user = _b.sent();
                        if (user) {
                            res_1 = { message: "Usuario logado", type: "success", body: user };

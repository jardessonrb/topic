...
var CommentRepository = /** @class */ (function (_super) {
    ...
    CommentRepository.prototype.findCommentByTopic = function (topicId) {
        return __awaiter(this, void 0, void 0, function () {
            var result, comments, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.createQueryBuilder("comments")
                    ...
                    case 1:
                        result = _a.sent();
                        comments = result.map(function (comment) {
                            return {
